...
public class LinkedIn extends ShareCountProvider {
    ...
    private static final String QUERY_URL = "https://www.linkedin.com/countserv/count/share?format=json&url=";
    private static final String NAME = "linkedin";

    public LinkedIn(ShariffBackendConfiguration configuration) {
